...
| [ClawHub](https://clawhub.ai) | Search for `eb-*` skills (publishing in progress) |
| [SkillDock.io](https://skilldock.io) | `skilldock skill install --namespace emersonbraun --slug <skill-name>` |
